              ...
              return ListTile(
                ...
                onTap: () {
                  ...
                  if(data[index]['collection'] == 'adPopUp') {
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> SablaAddPopUp()));

                  }if(data[index]['collection'] == 'adPopUp_malab') {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> MalabAddPopUp()));

                  }if(data[index]['collection'] == 'adPopUp_souq') {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> SouqAddPopUp()));

                  }if(data[index]['collection'] == 'adPopUp_magazen') {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> MagazenAddPopUp()));
