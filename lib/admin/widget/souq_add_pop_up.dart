...
class SouqAddPopUp extends StatefulWidget {

  const SouqAddPopUp({super.key});

  @override
  State<SouqAddPopUp> createState() => _SouqAddPopUpState();
}

class _SouqAddPopUpState extends State<SouqAddPopUp> {
  ...
  void initState() {
    super.initState();
    HomeCubit.get(context).featchAdSouqPopUpData();
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<HomeCubit, HomeState>(
      ...
      builder: (context, state) {
        ...
        textController = TextEditingController(text: cubit.adSouqPopUpData?.text);
        linkController = TextEditingController(text: cubit.adSouqPopUpData?.link);

        return Scaffold(
          appBar: buildAppBar(context, title: 'اعلان السوق', showBackButton: true),
          body: Padding(
                      ...
                      child: Container(
                        ...
                        child: newImagePath != null
                          ...
                          fit: BoxFit.cover,
                            ...
                            : cubit.adSouqPopUpData != null
                            ? Image.network(
                          cubit.adSouqPopUpData?.imageUrl ?? '',
                          fit: BoxFit.cover,
                      ...
                      children: [
                        state is updateAdPopUpLoading ||
                          ...
                          onPressed: () {
                            ...
                            if (cubit.adSouqPopUpData == null) {
                              // Create
                              cubit.uploadSouqAdPopUp(
                              ...
                              // Update
                              cubit.updateSouqAdPopUp(
                                text: textController.text,
                                link: linkController.text,
                                newImagePath: newImagePath,
                                oldImageUrl: cubit.adSouqPopUpData?.imageUrl ?? '',
                              );
                            }
                          },
                          child: Text(
                            cubit.adSouqPopUpData == null ? 'اضافه' : 'تحديث',
                        ...
                        if (cubit.adSouqPopUpData != null)
                          isButtonDisabled || state is deleteAdPopUpLoading
                            ...
                            onPressed: () {
                              ...
                              cubit.deleteSouqAdPopUp(imageUrl: cubit.adSouqPopUpData?.imageUrl ?? '');
                            },
